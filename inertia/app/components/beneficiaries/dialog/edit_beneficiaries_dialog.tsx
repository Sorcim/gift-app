...
export default function EditBeneficiariesDialog({
  open,
  setOpen,
  beneficiary,
}: {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    post(`/admin/beneficiaries/${beneficiary.id}`, {
      onSuccess: () => {
        setOpen(false)
      },
    })
    ...
    <DefaultDialog setOpen={setOpen} open={open}>
      <div className="bg-white sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-base font-semibold leading-6 text-gray-900">Edit a beneficiaries</h3>
